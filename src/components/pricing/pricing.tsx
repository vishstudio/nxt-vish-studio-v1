...
function PlanCard({ plan, index, tinaField, rawPlan }: {
  ...
  return (
    <motion.div
      ...
      className={`plan-card relative flex flex-col rounded-2xl border p-8 transition-all duration-300 ${plan.featured
...
export const Pricing = () => {
  ...
  return (
    <section className="pricing py-32 px-6 md:px-12 bg-vish-bg" id="pricing">
