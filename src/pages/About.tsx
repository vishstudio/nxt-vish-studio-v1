      ...
      <main className="pt-32">
        ...
        <section className="px-6 md:px-12 py-20 md:py-32 min-h-[80vh] flex flex-col justify-between">
          <div className="max-w-[1400px] mx-auto w-full">
            ...
            <h1 className="font-display text-7xl md:text-9xl font-medium tracking-tighter leading-[0.85] text-white">
              <motion.span 
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-start">
                    ...
                    <div className="space-y-12 lg:pt-24">
                        ...
                        <motion.div 
                            ...
                            className="font-sans text-xl text-gray-400 space-y-8 leading-relaxed"
                        >
                            <p>
